...
enum PortToThreadConfig(val description: String, val port: Int):
  ...
  case CachedThreadPoolVirtualThreadPool extends PortToThreadConfig("Cached Thread Pool with Virtual Thread Pool", 8085)
  case FixedThreadPool extends PortToThreadConfig("Fixed Thread Pool", 8086)
  case FixedThreadPoolVirtualThreadPool extends PortToThreadConfig("Fixed Thread Pool with Virtual Thread Pool", 8087)
  case FixedThreadPoolCachedThreadPool extends PortToThreadConfig("Fixed Thread Pool with Cached Thread Pool", 8088)
